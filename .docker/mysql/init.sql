...
(
    ...
    ' Медитация — это практика, которая существует уже тысячи лет и помогает людям достигать внутреннего спокойствия и гармонии. Она включает в себя различные техники, которые направлены на улучшение концентрации, снижение стресса и обретение ясности ума.'
),
(
